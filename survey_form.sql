...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3464958463ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=survey_form&table=userData">`survey_form`.`userData`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=survey_form&table=userdata">`survey_form`.`userdata`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=survey_form&table=data">`survey_form`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=videos">`videowebsite`.`videos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=channels">`videowebsite`.`channels`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=users">`videowebsite`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=comments">`videowebsite`.`comments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videos&table=videos">`videos`.`videos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=video">`videowebsite`.`video`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=videowebsite&table=u_v">`videowebsite`.`u_v`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6d2a7173703e476264374c51683a5e4e">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="survey_form" targettable="data">
            ...
            Queried time
                            ...
                            targetdb="survey_form" targettable="userdata">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `survey_form`.`userdata` ( `User_ID` INT(11) NOT NULL AUTO_INCREMENT ,  `UserName` VARCHAR(20) NOT NULL ,  `UserAge` INT(11) NOT NULL ,  `CurrentRole` VARCHAR(255) NOT NULL ,  `FriendFreeCodeCamp` VARCHAR(255) NOT NULL ,  `FeatureOfFreeCodeCamp` VARCHAR(255) NOT NULL ,  `ImproveField` VARCHAR(255) NOT NULL ,  `Suggestions` TEXT NOT NULL ,    PRIMARY KEY  (`User_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="survey_form" targettable="userData">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userData`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="survey_form" targettable="userData">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO userdata(UserName,UserEmail,UserAge,CurrentRole,FriendFreeCodeCamp,FeatureOfFreeCodeCamp,ImproveField,Suggestions) values (&#039;doha&#039;,&#039;doha@gmail.com&#039;,&#039;20&#039;,&#039;yes&#039;,&#039;hi&#039;,&#039;jfak&#039;,&#039;a;kfna&#039;,&#039;fajfjajkf &#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="survey_form" targettable="userData">
                            <div class="action_content">
